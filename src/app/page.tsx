// For Visual Reference - The final, responsive code for: src/app/page.tsx
  ...
  return (
    <main>
      ...
      <section className="relative h-screen flex items-center justify-center">
        {/* ... (no changes needed for the background image) ... */}
        <Image src={heroImage} alt="A beautiful view from Casa Calala" fill className="object-cover -z-10" placeholder="blur" priority />
        <div className="absolute inset-0 bg-black bg-opacity-40" />

        <div className="relative text-center text-white p-4">
          <div className="mb-4">
            <Image src="/logo.png" alt="Casa Calala Logo" width={320} height={320} className="mx-auto" />
          </div>
          {/* On mobile, text is 5xl. On medium screens and up, it becomes 7xl. */}
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
            Your Granada Getaway
          </h1>
          {/* On mobile, text is lg. On medium screens and up, it becomes xl. */}
      ...
      {/* ===== STORY / ABOUT SECTION ===== */}
      {/* On mobile, padding is less (py-16). On medium screens, it's more (md:py-24). */}
      <section className="bg-gray-50 py-16 md:py-24">
        {/* On mobile, padding is 6. On medium screens, it's the same. */}
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            {/* On mobile, text is 3xl. On medium screens, it becomes 4xl. */}
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* On mobile, it's a single column grid. On medium screens and up, it becomes 3 columns. */}
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            {/* ... (The content inside the icons doesn't need to change, the grid handles the layout) ... */}
            <div className="p-4">
